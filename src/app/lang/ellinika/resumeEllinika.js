...
export const ResumeEllinika = {
  ...
  'error': {
    "pdf": "Δεν μπορούμε να κατεβάσουμε το αρχείο PDF. Ίσως αυτό το βιογραφικό να μην είναι δημόσιο.",
    "html": "Δεν μπορούμε να κατεβάσουμε το αρχείο HTML. Ίσως αυτό το βιογραφικό να μην είναι δημόσιο.",
    "json": "Δεν μπορούμε να κατεβάσουμε το αρχείο JSON. Ίσως αυτό το βιογραφικό να μην είναι δημόσιο.",
    "iFrame": "Δεν μπορούμε να βρούμε το HTML iFrame URL. Ίσως αυτό το βιογραφικό να μην είναι δημόσιο."
  }
}
